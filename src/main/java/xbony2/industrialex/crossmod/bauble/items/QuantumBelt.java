...
public class QuantumBelt extends Item implements IElectricItemBony, IBauble{
	public QuantumBelt(String unlocalized, boolean charged){
		super();
		...
		if(!charged){
			this.setDamage(new ItemStack(Baubles.unChargedQuantumBelt), 1);
		}
	}
	...
	public Item getChargedItem(ItemStack itemStack) {
		return Baubles.chargedQuantumBelt;
	}

	@Override
	public Item getEmptyItem(ItemStack itemStack) {
		return Baubles.unChargedQuantumBelt;
	}
